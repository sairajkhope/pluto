...
.. code:: bash
   ...
   │   ├── algorithms  # ZMP-based trajectory planning for bipedal walking
   ...
   │   ├── manipulation  # diffusion policy and teleoperation
   ...
   │   ├── skill_classifier  # vision-based skill classification and planning
